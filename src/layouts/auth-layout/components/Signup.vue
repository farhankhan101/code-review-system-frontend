      ...
      >
        <div class="relative w-full">
                    ...
                    <g transform="matrix(1 0 0 1 0.03 0)">
                      <path
                        style="
                          ...
                          opacity: 1;
                        "
                        transform=" translate(-7.03, -7)"
                        d="M 9.91344 6.99985 C 9.91336 7.56831 9.74533 8.12407 9.43043 8.59735 C 9.11554 9.07062 8.66783 9.44031 8.14353 9.65998 C 7.61923 9.87965 7.04172 9.93952 6.48351 9.83205 C 5.92529 9.72459 5.41128 9.45459 5.00601 9.05597 C 4.60074 8.65734 4.32228 8.14786 4.20561 7.5915 C 4.08893 7.03514 4.13924 6.45671 4.35022 5.92885 C 4.5612 5.40099 4.92344 4.94724 5.39144 4.62457 C 5.85945 4.3019 6.41236 4.1247 6.98074 4.11522 C 7.36358 4.10884 7.74386 4.17874 8.09941 4.32085 C 8.45496 4.46295 8.77865 4.67442 9.05163 4.94292 C 9.3246 5.21142 9.54139 5.53158 9.68936 5.88473 C 9.83732 6.23788 9.91349 6.61695 9.91344 6.99985 L 9.91344 6.99985 Z"
                        stroke-linecap="round"
                      />
                    </g>
          ...
          <div class="flex flex-col">
            ...
            <span v-if="usernameError?.length > 0" class="text-red-600">{{
              usernameError
            }}</span>
          </div>
        </div>
        <div class="relative w-full">
                  ...
                  <g style="">
                    <g transform="matrix(1 0 0 1 0 0)">
                      <path
                        ...
                        d="M 1.03167 10.5367 C 1.15058 11.4945 1.92435 12.2511 2.88428 12.3515 C 4.21258 12.4903 5.58924 12.6369 7 12.6369 C 8.41076 12.6369 9.78742 12.4903 11.1157 12.3515 C 12.0756 12.2511 12.8494 11.4945 12.9683 10.5367 C 13.1103 9.39313 13.25 8.21051 13.25 6.99998 C 13.25 5.78944 13.1103 4.60683 12.9683 3.46329 C 12.8494 2.50549 12.0756 1.74885 11.1157 1.6485 C 9.78742 1.50965 8.41076 1.36304 7 1.36304 C 5.58924 1.36304 4.21257 1.50965 2.88428 1.6485 C 1.92435 1.74885 1.15058 2.50549 1.03166 3.46329 C 0.88969 4.60683 0.75 5.78944 0.75 6.99998 C 0.75 8.21051 0.88969 9.39313 1.03167 10.5367 Z"
                        stroke-linecap="round"
                      />
                    </g>
                    <g transform="matrix(1 0 0 1 0 -1.73)">
                      <path
                        style="
                          ...
                          opacity: 1;
                        "
                        transform=" translate(-7, -5.27)"
                        d="M 1.05957 3.20435 L 5.76169 6.91181 C 6.48793 7.48443 7.51207 7.48443 8.23831 6.91181 L 12.9404 3.20435"
                        stroke-linecap="round"
                      />
                    </g>
                  </g>
          ...
          <div class="flex flex-col">
            ...
            <span v-if="emailError?.length > 0" class="text-red-600">{{
              emailError
            }}</span>
          </div>
        </div>
                      ...
                      <g transform="matrix(1 0 0 1 -0.46 -2.27)">
                        <path
                          style="
                            ...
                            stroke-linejoin: miter;
                            stroke-miterlimit: 4;
                            fill: rgb(137, 220, 255);
                            fill-rule: nonzero;
                            opacity: 1;
                          "
                          transform=" translate(-6.54, -4.73)"
                          d="M 0.941675 6.97613 C 1.07838 7.97 1.94086 8.71118 2.9441 8.71118 L 10.1367 8.71118 C 11.14 8.71118 12.0025 7.97 12.1392 6.97613 C 12.2434 6.21851 12.3308 5.43336 12.3308 4.73059 C 12.3308 4.02782 12.2434 3.24267 12.1392 2.48506 C 12.0025 1.49118 11.14 0.75 10.1367 0.75 L 2.9441 0.75 C 1.94086 0.75 1.07838 1.49118 0.941674 2.48505 C 0.837469 3.24266 0.75 4.02782 0.75 4.73059 C 0.75 5.43336 0.837469 6.21852 0.941675 6.97613 Z"
                          stroke-linecap="round"
                        />
                      </g>
                      <g transform="matrix(1 0 0 1 -0.47 -2.27)">
                        <path
                          style="
                            ...
                            opacity: 1;
                          "
                          transform=" translate(-6.53, -4.73)"
                          d="M 5.70094 8.71118 L 2.9441 8.71118 C 1.94086 8.71118 1.07838 7.97 0.941675 6.97613 C 0.837469 6.21852 0.75 5.43336 0.75 4.73059 C 0.75 4.02782 0.837469 3.24266 0.941674 2.48505 C 1.07838 1.49118 1.94086 0.75 2.9441 0.75 L 10.1367 0.75 C 11.14 0.75 12.0025 1.49119 12.1392 2.48507 C 12.2083 2.98763 12.27 3.50231 12.3038 3.99702"
                          stroke-linecap="round"
                        />
                      </g>
                      <g transform="matrix(1 0 0 1 -3.21 -2.27)">
                        <path
                          style="
                            ...
                            opacity: 1;
                          "
                          transform=" translate(-3.79, -4.73)"
                          d="M 3.78662 4.60254 L 3.78662 4.85864"
                          stroke-linecap="round"
                        />
                      </g>
                      <g transform="matrix(1 0 0 1 -0.46 -2.27)">
                        <path
                          ...
                          "
                          transform=" translate(-6.54, -4.73)"
                          d="M 6.54053 4.60254 L 6.54053 4.85864"
                          stroke-linecap="round"
                        />
                      </g>
                      <g transform="matrix(1 0 0 1 2.29 -2.27)">
                        <path
                          style="
                            ...
                            opacity: 1;
                          "
                          transform=" translate(-9.29, -4.73)"
                          d="M 9.29419 4.60254 L 9.29419 4.85864"
                          stroke-linecap="round"
                        />
                      </g>
                      <g transform="matrix(1 0 0 1 3.65 1.53)">
                        <path
                          style="
                            ...
                            opacity: 1;
                          "
                          transform=" translate(-10.65, -8.53)"
                          d="M 12.24 9.73438 L 12.24 8.92639 C 12.24 8.7174 12.1988 8.51046 12.1188 8.31738 C 12.0389 8.1243 11.9216 7.94886 11.7739 7.80108 C 11.6261 7.6533 11.4507 7.53608 11.2576 7.4561 C 11.0645 7.37612 10.8575 7.33496 10.6486 7.33496 C 10.4396 7.33496 10.2326 7.37612 10.0395 7.4561 C 9.84646 7.53608 9.67103 7.6533 9.52325 7.80108 C 9.37547 7.94886 9.25825 8.1243 9.17827 8.31738 C 9.09829 8.51046 9.05713 8.7174 9.05713 8.92639 L 9.05713 9.73438"
                          stroke-linecap="round"
                        />
                      </g>
...
export default defineComponent({
  ...
  setup() {
    ...
    // Watcher for username with debounce
    watch(
      () => formData.username,
      async (newUsername) => {
        if (newUsername) {
          ...
          try {
            const response = await ApiService.query(
              `/api/v2/user/validate_username/${newUsername}/`,
              {}
            );
    ...
    // Watcher for email with debounce
    watch(
      () => formData.email,
      async (newEmail) => {
        if (newEmail) {
          ...
          try {
            const response = await ApiService.query(
              `/api/v2/user/validate_email/${newEmail}/`,
              {}
            );
            if (response.data.status == "S") {
              emailError.value = "";
