    ...
    <div class="border w-full max-w-md p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
      ...
      <form class="mt-8 space-y-6" action="#">
              ...
              <div class="flex justify-center">
                <button type="submit" class="w-[158px] px-4 py-2 text-base font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Signup via Gmail
                </button>
              </div>
